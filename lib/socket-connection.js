 ...
 */
SocketConnection.prototype.sendErrorAndClose = function(err) {
    this._sendError(err);
 ...
 * @private
 */
SocketConnection.prototype._sendError = function(err) {
    this._send({msg:SocketConnection.ServerMessages.ERROR, data: err});
};
