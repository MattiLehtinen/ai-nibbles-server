...
var SNAKE_COUNT = 2;
var DELAY = 20;
var TIME_LIMIT = 3 * 60; // Maximum playing time in seconds
...
Game.prototype.start = function() {
    ...
    this._endTime = this._startTime + TIME_LIMIT * 1000;
...
Game.prototype._updateAlive = function(timeLeft) {

    if(timeLeft <= 0) {
        // Time is up. All snakes will die.
        _.forEach(this._snakes, function(snake) {snake.alive = false;} );
